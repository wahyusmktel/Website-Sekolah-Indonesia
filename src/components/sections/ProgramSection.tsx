...
import { Code, Network, Palette, Calculator, TrendingUp, FileText, ArrowRight, Layers, Loader2 } from "lucide-react";
                ...
                >
                  <div className="relative bg-white dark:bg-foreground/5 rounded-[2.5rem] overflow-hidden border border-border group-hover:border-primary/50 transition-all duration-500 shadow-soft group-hover:shadow-glow h-full flex flex-col">
                    ...
                    <div className="p-10 flex flex-col flex-1">
                      ...
                      <p className="text-muted-foreground font-light leading-relaxed mb-8 flex-1 line-clamp-3">
                        {program.short_desc}
                      </p>

                      <div className="flex flex-wrap gap-2 mb-8">
                        {prospects.slice(0, 2).map((job: string, i: number) => (
